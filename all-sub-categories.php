				...
				<div class="sb2-2">
					<div class="sb2-2-2">
						<ul>
							...
							<li class="active-bre"><a href="#">All Sub Categories</a>
							</li>
						</ul>
					</div>
					<div class="sb2-2-3">
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box-inn-sp">
									<?php
									$sql = "SELECT * FROM categories WHERE parent_category_code != '0' AND category_level = '2'";
									$result = $connection->query($sql);
									if ($result->num_rows > 0) {
										?>
										<div class="inn-title">
											<h4 class="txt-center">All Sub Categories</h4>
										</div>
										<div class="tab-inn">
											<div class="table-responsive table-desi">
												<table class="table table-hover">
													...
													<?php while ($row = $result->fetch_array()) { ?>
														...
														<tr id="myDIV">
															<form action="include/update_sub_category.php" method="post" enctype="multipart/form-data">
																<td>
																...
																<td>
																	<a href="include/delete_sub_category.php?id=<?php echo $row['id']; ?>">
									...
									<?php } else { ?>
										<h3 class="text-center">Sorry, there are no sub categories to display to create
											one
											<a href="add-sub-category.php">click here</a>.
										</h3>
									<?php } ?>
								</div>
							</div>
